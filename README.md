...
Our data can be collected from the Centers for Disease Control and Prevention's (CDC) files here. From the get-go, we should be aware that given the current news cycle in the US, the CDC's data is bound to change as we learn more about newly recorded cases and deaths from COVID-19. The data included in this project accounts for cases and deaths up to November 30.
